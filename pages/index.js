              ...
              <dl className="divide-y divide-gray-200 dark:divide-black">
                <div className="py-2 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                    ...
                    <a
                      target="_blank"
                      href="mailto:marcos.lozada@ucc.edu.ar"
                      className="hover:text-blue-400"
                    >
                      marcos.lozada@ucc.edu.ar
                    </a>{" "}
                    |{" "}
                    <a
                      target="_blank"
                ...
                <div className="py-2 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-gray-100 dark:bg-black text-gray-800 mr-3 dark:text-white mb-1">
                      <a
                        target="_blank"
                        href="https://cal.com/marcoslozada/15min?duration=15"
                        className="hover:text-blue-400"
                      >
                        15 min meeting
                      </a>
                    ...
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-gray-100 dark:bg-black text-gray-800 mr-3 dark:text-white mb-1">
                      <a
                        target="_blank"
                        href="https://cal.com/marcoslozada/30min?duration=30"
                        className="hover:text-blue-400"
                      >
                        30 min meeting
                      </a>
                ...
                <div className="py-2 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-gray-100 dark:bg-black text-gray-800 mr-3 dark:text-white mb-1">
                      <a
                        target="_blank"
                        href="https://www.linkedin.com/comm/mynetwork/discovery-see-all?usecase=PEOPLE_FOLLOWS&followMember=marcoslozadafreytes"
                        className="hover:text-blue-400"
                      >
                        Follow on LinkedIn
                      </a>
...
const techStack = [
  ...
  {
    name: "AWS",
    logo: "/images/tech-stack/aws.svg",
    height: 48,
    width: 55,
  ...
  {
    name: "OpenAI",
    logo: "/images/tech-stack/openai.svg",
    height: 68,
    width: 75,
